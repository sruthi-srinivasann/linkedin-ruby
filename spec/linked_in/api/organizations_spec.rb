...
describe LinkedIn::Organizations do
  ...
  it "should be able to view an organization profile" do
    stub("https://api.linkedin.com/rest/organizations/1586")
  ...
  it "should be able to view an organization by vanity name" do
    stub("https://api.linkedin.com/rest/organizations?q=vanityName&vanityName=acme")
  ...
  it "should be able to view an organization by e-mail domain" do
    stub("https://api.linkedin.com/rest/organizations?q=emailDomain&emailDomain=acme.com")
